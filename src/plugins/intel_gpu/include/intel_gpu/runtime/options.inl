...
OV_CONFIG_RELEASE_OPTION(ov::intel_gpu, enable_megakernel, true, "MegaKernel PoC: fold the decoder of a supported model into a single decode-only MegaKernel primitive")
